...
def main():
    ...
    #tweaks.add_diversion(enc.forward, (lambda *args, **kwargs: print('encoder.forward, args:', args, kwargs)))
    #tweaks.add_diversion(dec.forward, (lambda *args, **kwargs: print('decoder.forward, args:', args, kwargs) or sys.exit(0)))
    #tweaks.add_diversion(model.forward, (lambda *args, **kwargs: print('model.forward, args:', args, kwargs)))
